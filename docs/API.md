...
**Errors:**
- `VoteIsClosed` (6000): Vote is no longer active
- `InvalidTokenMint` (6001): Token mint doesn't match vote's token mint
- `NotEnoughTokens` (6002): Voter doesn't have enough tokens
...
**Errors:**
- `VoteIsClosed` (6000): Vote is no longer active
- `InvalidDelegate` (6003): Delegate doesn't match delegation record
- `DelegateNotAuthorized` (6004): Delegate not authorized for this owner
- `InvalidTokenMint` (6001): Token mint doesn't match
- `NotEnoughTokens` (6002): Owner doesn't have enough tokens
...
**Errors:**
- `VoteIsClosed` (6000): Vote is already closed (if somehow called twice)
...
Smart contract errors are returned as Anchor error codes (6000-6004) and can be caught in transaction receipts.
